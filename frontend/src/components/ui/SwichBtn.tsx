...
const SwichBtn = () => {
  ...
  return (
    ...
    >
      {isDarkMode?
       <img className="translate-x-[-8px] w-[14px] transition1" src="/icons/moon.png" alt="" /> 
      : <img className="translate-x-[-35px] w-[18px] transition1 " src="/icons/sun.png" alt="" /> }
      ...
      <div id="Circle"
        ...
        style={{ background: isDarkMode
          ...
          transform: isDarkMode? "translateX(1px) translateY(0.5px)" : "translateX(30px) translateY(1px)" ,
        }}>
      </div>
    </button>
  );
